...
export default function AltDogCard({ dog }: AltDogCardProps) {
  ...
  return (
    <div
      ...
      {...focusProps}
      tabIndex={0}
      className="rounded-lg mt-2 p-4 shadow-md cursor-pointer min-w-[165px] w-[165px] relative focus:outline-0"
      onClick={() => navigate(`/dogdetails/${dog.id}`)}
    ...
    >
      <Ripple />
      <div
        className="rounded-lg w-full h-[5rem] flex items-center justify-center font-bold text-[1.5rem] mb-2"
        style={{
